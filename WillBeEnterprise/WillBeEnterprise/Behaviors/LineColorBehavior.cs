...
using System.Linq;
using WillBeEnterprise.Effects;
using Xamarin.Forms;

namespace WillBeEnterprise.Behaviors
{
    public static class LineColorBehavior
    {
        ...
        {
            get { return (Color)LineColorProperty.DefaultValue; }
            set
            {
                Debug.WriteLine("Some is trying to set LineColor!");
            }
        }
